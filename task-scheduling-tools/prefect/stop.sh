...
# Stop containers
print_info "Stopping Prefect containers..."
if docker-compose down; then
    print_status "Prefect containers stopped"
else
...
if [ "$CLEANUP_VOLUMES" = true ]; then
    ...
    if [ "$FORCE" = true ]; then
        ...
        echo -e "${YELLOW}⚠️  This will remove all Prefect data including flows, runs, and database.${NC}"
